...
import { IToDoListAeitState } from './IToDoListAeitState';

export default class DropdownSelector extends React.Component<IToDoListAeitProps, IToDoListAeitState> {
    private selectedKey: React.ReactText;

    constructor(props: IToDoListAeitProps, state: IToDoListAeitState) {
        super(props);
    ...
    private onChanged(option: IDropdownOption, index?: number): void {
        ...
        this.setState((prevState: IToDoListAeitState, props: IToDoListAeitProps): IToDoListAeitState => {
